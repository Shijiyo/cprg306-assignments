...
export default function NewItem() {
  ...
  return (
    ...
    >
      ...
      {/* Name input */}
      <div>
        <label className="block text-left font-semibold text-gray-800">Item Name</label>
        <input
          type="text"
          required
          value={name}
      ...
      {/* Quantity selector */}
      <div>
        <label className="block text-left font-semibold text-gray-800">Quantity</label>
      ...
      {/* Category dropdown */}
      <div>
        <label className="block text-left font-semibold text-gray-800">Category</label>
        <select
          value={category}
